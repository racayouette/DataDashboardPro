...
export default function Editing() {
  ...
  const renderPopupTrackedChanges = () => {
    if (!popupTrackChangesMode || popupJobSummary === popupOriginalJobSummary) {
      return (
        <div className="flex-1 min-h-[250px] border border-gray-300 rounded-md bg-gray-50 p-3 overflow-y-auto">
          <div 
            className="text-sm"
            style={{ 
              lineHeight: '1.5',
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <Dialog open={showJobSummaryPopup} onOpenChange={(open) => {
        ...
        <DialogContent className="max-w-6xl h-[75vh] flex flex-col" aria-describedby="job-summary-editor-description">
          <DialogHeader>
            ...
            <div className="flex-1 flex gap-4">
              ...
              <div className="flex-1 flex flex-col">
                ...
                <Textarea
                  ...
                  className="flex-1 min-h-[250px] text-sm resize-none border border-gray-300"
